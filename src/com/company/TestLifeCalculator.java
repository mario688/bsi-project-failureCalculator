 ...
 */
public class TestLifeCalculator {
    double reliability;
    double sample;
    ...
    public void testLifeCalulator() {
        ...
        double result = Math.pow((pom), (1 / weibull)) * magnitudeOfLife;

        System.out.println( TextColor.RED + String.format("%.0f", result) + " miles/hours");
    }
